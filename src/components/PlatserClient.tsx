...
function catIcon(cat: string) {
 if (cat === 'kafe') return <Icon name="coffee" size={20} style={{ color: '#fff' }} />
 if (cat === 'bensin') return <Icon name="fuel" size={20} style={{ color: '#fff' }} />
 if (cat === 'hamn') return <Icon name="anchor" size={20} style={{ color: '#fff' }} />
 return <Icon name="utensils" size={20} style={{ color: '#fff' }} />
}
