...
export default async function PublicProfilePage({
 ...
 <div style={{ fontSize: 10, fontWeight: 600, color: 'var(--txt3)', textTransform: 'uppercase', letterSpacing: '0.6px', display: 'flex', alignItems: 'center', gap: 4 }}><Icon name="anchor" size={10} /> Besökta öar</div>
