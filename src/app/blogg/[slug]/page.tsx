...
Rekommendation för nybörjare: boka en halvdagstur med en certifierad guideverksamhet första gången. Du lär dig grunderna på ett säkert sätt och får tipsen om de bästa rutterna. Efteråt kan du med god marginal ge dig ut på egna äventyr.

## Paddla i andra svenska vatten

Stockholms skärgård är ett av Sveriges bästa kajakvatten – men det finns fler.

**Mälaren** är ett utmärkt alternativ för nybörjaren som vill börja i lugnare vatten. Insjöpaddling utan tidvatten, utan saltvatten och med kortare sträckor mellan hamnarna. Runt Strängnäs, Björnö och Mariefred finns välskötta paddelleder med enkla möjligheter att ta sig ur vattnet om vädret ändras.

**Göteborg skärgård** erbjuder ett helt annat landskap. De nakna klipporna i Göteborg skärgård – Marstrand, Tjörn, Orust – är dramatiska och vackra, men kräver lite mer erfarenhet på grund av mer exponerat hav och starkare vindar.
    `,
  },
...
## Planera längre expeditioner

Stockholms skärgård är ett utmärkt hem-revir – men med bra bränsleplanering är Östersjön öppen.

**Gotland:** Ca 100–130 NM från Landsort vid bra vind. Nynäshamn är det bästa sista tankstoppet på svenska sidan. Gotland har bra bränsleutbud i Visby hamn och Klintehamn.

**Åland:** Drygt 130 NM från Furusund med god vind. Kapellskär är närmaste förberedelsepunkt. Ålands hav kan vara krävande – se till att ha full tank och reservkapacitet innan överfarten.
    `,
  },
...
## Fiske i andra svenska farvatten

Stockholms skärgård är utgångspunkten – men Sverige har fler av världens bästa sportfiskevatten.

**Bohuslän och Västerhavet** är Skandinaviens mekka för havsfiske. Makrill, kolja, torsk och havskräftor i ett landskap av nakna klippor och djupa fjordar. Fisket här är ett steg upp i skala från Stockholms skärgård – mer öppet hav, kraftigare strömmar, fler arter. Sportfiskebåtar hyrs ut längs hela kusten från Strömstad till Göteborg.

Utforska mer om fiske och friluftsliv längs Västerhavet och Bohuslän – två av Sveriges starkaste fiskeregioner.
    `,
  },
...
## Gästhamnar utanför Stockholms skärgård

Planerar du en större tur? Sverige erbjuder fantastiska gästhamnar längs hela kusten.

**Gotland – Visby:** En av Östersjöns bästa gästhamnar. Visby Norr- och Söderhamnarna är välskötta med full service. Stadsmuren och medeltidsstaden direkt från bryggan är oöverträffat som resemål. Köer i juli – boka i förväg.

**Bohuslän – Marstrand, Smögen, Lysekil:** Bohuslänkusten har Sverige bästa gästhamnar för västkustseglingen. Marstrand med sin fästning och täta restaurangutbud är en klassiker. Smögen är mer folklig och levande. Lysekil mer lugn och naturskön.

**Mälaren:** Glöm inte insjöfarleden. Strängnäs, Västerås och Mariefred (Gripsholms slott direkt från bryggan) är bland Mälarens bästa gästhamnar. Perfekt för de som seglar i sötvatten.

**Blekinge skärgård:** En underskattad bit av Sverige. Karlskrona (UNESCO-världsarv och marinhamn) är en av landets mest unika gästhamnar.
    `,
  },
...
## Vinter i andra vattenlandskap

**Mälaren på vintern** är ett helt eget kapitel. I kalla vintrar fryser stora delar av Mälaren och erbjuder skridskoåkning på naturis i skala som inte finns på Östersjön. Långa istur från Stockholm ut mot Strängnäs, Björnö och Sättra är en tradition bland erfarna skridskoåkare. Kolla Mälarens iskartor på SMHI – förhållandena varierar kraftigt år till år.
    `,
  },
...
## Havsbastu utanför Stockholm

Bastukulturen är stark längs hela den svenska kusten.

**Bohuslän och Göteborg skärgård:** Västerhavet och de nakna klipporna skapar en annan bastudramatik än Stockholms skärgård. Strömstad, Fjällbacka och Göteborg skärgård har flertalet välskötta havsbastuar direkt vid Nordsjöns öppna hav. Doppen är kallare – havet är mer av ett hav. Det är just det som är poängen.

**Västerhavet** erbjuder en rå och vindpiskad bastuupplevelse som är svårt att hitta på Östersjösidan. Om du vill ha maximal kontrast och lite mer äventyr i bastuupplevelsen – det är dit du åker.
    `,
  },
...
## Svenska seglarleder bortom Stockholm

Stockholms skärgård är startpunkten för många – men Sverige har klassiska leder längs hela kusten.

**Bohuslän och Göteborg skärgård:** Västerhavsleden från Göteborg norrut mot Strömstad är en av Skandinaviens mest dramatiska seglarleder. Nakna klippor, djupa sund och ett fiskesamhälle vid varje ankring. Marstrand, Lysekil, Smögen, Fjällbacka – vart och ett är värt ett eget stopp.

**Gotland:** Att segla runt Gotland är ett klassiskt mål för erfarna svenska seglare. Visby hamn som bas, gotländska klintar (klippväggar) längs ostkusten och Hoburgen i söder – ett 400 NM äventyr om du tar hela ön.

**Åland:** Ålands hav och den finska skärgårdsleden är Östersjösegling på sin bästa – tiotusentals öar, skyddade leder och en annan natur än den svenska. Mariehamn är knutpunkten. Från Stockholm är det ca 2 dagar med god vind.

**Blekinge skärgård:** En underskattad led längs sydkusten. Karlskrona som startpunkt, sedan ut i Blekinges skärgård som är mer glesbefolkad och naturskön än vad de flesta känner till.
    `,
  },
}
...
const REGION_LINKS: Record<string, { href: string; label: string }[]> = {
  ...
  'kajak-stockholms-skargard-nyborjare': [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }, { href: '/malaren', label: '🌊 Mälaren' }, { href: '/goteborg-skargard', label: '⚓ Göteborg skärgård' }],
  'dolda-parlor-moja':                 [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }],
  'bransle-ankring-skargard':          [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/hamnar-och-bryggor', label: '⚓ Hamnar & bryggor' }, { href: '/gotland', label: '🏰 Gotland' }, { href: '/aland', label: '🗺 Åland' }],
  'sommar-skargard-tips':              [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }],
  ...
  'basta-badplatserna':                [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }],
  'vandring-orno-uto':                 [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }],
  'cykling-moja-gallno':               [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }],
  'fiske-skargard-guide':              [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }, { href: '/bohuslan', label: '🎣 Bohuslän' }, { href: '/vasterhav', label: '🌊 Västerhavet' }],
  'gasthamnar-guide':                  [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/hamnar-och-bryggor', label: '⚓ Hamnar & bryggor' }, { href: '/gotland', label: '🏰 Gotland' }, { href: '/bohuslan', label: '⚓ Bohuslän' }, { href: '/malaren', label: '🌊 Mälaren' }, { href: '/blekinge-skargard', label: '🏝 Blekinge skärgård' }],
  'vinter-skargard':                   [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/malaren', label: '❄️ Mälaren' }],
  'barnfamilj-skargard':               [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }],
  ...
  'havsbastu-guide':                   [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/aktiviteter', label: '🎯 Aktiviteter' }, { href: '/vasterhav', label: '🌊 Västerhavet' }, { href: '/bohuslan', label: '🧖 Bohuslän' }, { href: '/goteborg-skargard', label: '⚓ Göteborg skärgård' }],
  'segling-klassiska-leder':           [{ href: '/stockholms-skargard', label: '🏝 Stockholms skärgård' }, { href: '/segelrutter', label: '🗺 Segelrutter' }, { href: '/bohuslan', label: '⛵ Bohuslän' }, { href: '/gotland', label: '🏰 Gotland' }, { href: '/aland', label: '🗺 Åland' }, { href: '/goteborg-skargard', label: '⚓ Göteborg skärgård' }, { href: '/blekinge-skargard', label: '🏝 Blekinge skärgård' }],
}
