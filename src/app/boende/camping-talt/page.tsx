    ...
    <CategoryLanding
      ...
      deeperContent={
        <>
          ...
          <p>
            I Sverige får du tälta på mark du inte äger — men inte hur som helst. Du ska hålla minst 70 meter från närmaste bostad och inte ligga kvar mer än ett par nätter på samma plats. I naturreservat gäller reservatets egna föreskrifter, som kan förbjuda tältning helt eller begränsa den till anvisade platser. Fågelskyddsområden med landstigningsförbud 1 april–15 juli gäller på en del öar.
          </p>
