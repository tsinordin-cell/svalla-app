...
/**
 * PATCH /api/admin/site-feedback/[id]
 * Markerar en site_feedback-rad som löst eller olöst.
 * Kräver is_admin = true.
 */
export async function PATCH(
  ...
  if (error) {
    logger.error('admin/site-feedback', 'update failed', { id, error: error.message })
