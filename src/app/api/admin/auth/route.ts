 ...
 *
 * Lösenord läses från env ADMIN_PASSWORD med fallback 'Admin1337!'.
 * (Sätt ADMIN_PASSWORD i Vercel env för att rotera.)
 */
import { NextResponse } from 'next/server'

export const dynamic = 'force-dynamic'

const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'Admin1337!'
