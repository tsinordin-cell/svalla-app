...
export const GUIDES: GuideMeta[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Vad gäller för toalettavfall på båt?', a: 'Sedan 1 april 2015 är det förbjudet att släppa ut toalettavfall från fritidsbåtar i hela Sveriges sjöterritorium — det räknas ut till 12 sjömil från baslinjen, alltså långt utanför de yttersta öarna — och i alla svenska sjöar och vattendrag. Förbudet gäller allt toalettavfall, även renat, och alla fritidsbåtar utom k-märkta. Tanken töms på en pump-out-station i gästhamn eller vid en mottagningsstation i land. Disk- och tvättvatten omfattas inte av förbudet.' },
    ],
  },
  {
  ...
  },
  {
    ...
    fullContent: true,
    faqs: [
      // KÄLLA: SL 2025 (pendelbåt 83 upphörde som SL-linje 29 april 2025) + Waxholmsbolagets tidtabell linje 4A 2026 + waxholmsbolaget.se om SL-biljetter (44 bryggor, Strömkajen-Vaxholm med omnejd). SL har enhetstaxa sedan 9 januari 2017 - inga zoner.
      { q: 'Vilka pendelbåtslinjer finns i Stockholm?', a: 'Waxholmsbolaget driver flest linjer – till Vaxholm (linje 4A sedan pendelbåt 83 lades ned som SL-linje i april 2025), Lidingö, Djurgården, Nacka Strand och ytterskärgården. Strömma trafikerar Djurgården, Fjäderholmarna och turistlinjerna. SL-biljetter gäller i skärgårdstrafiken mellan 44 bryggor, från Strömkajen till Vaxholm med omnejd.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Vad är Kosterhavet?', a: 'Kosterhavets nationalpark är Sveriges första marina nationalpark och Europas artrikaste hav norr om Portugal. Djupa korallrev, sjöborrar, hummer och hundratals marina arter finns i Kosterfjorden.' },
