...
export const GUIDES: GuideMeta[] = [
  ...
  // ── Batch M: Timely + evergreen SEO-gap aug 2026 ──────────────────────────
  { slug: "gasthamnar-guide-2026", title: "Bästa gästhamnarna i Stockholms skärgård 2026 – priser, faciliteter och tips", excerpt: "En komplett guide till gästhamnarna i Stockholms skärgård. Priser, djup, el, bastu och hur du hittar ledig plats under högsäsong.", category: "Praktisk", emoji: "⚓", readTime: "10 min", fullContent: true, featured: true, faqs: [{ q: 'Hur mycket kostar det att ligga i gästhamn i Stockholms skärgård?', a: 'Priserna varierar: enklare hamnar 150–250 kr/natt, populärare hamnar som Sandhamn och Grinda 300–500 kr/natt. El kostar 50–100 kr extra. Gästhamnsappen Marinas.com och Navily visar aktuella priser.' }, { q: 'Vilka gästhamnar i Stockholms skärgård har bastu?', a: 'Utö, Sandhamn, Grinda, Möja och Finnhamn erbjuder bastu i eller vid gästhamnen. De flesta kräver förbokning – kontakta hamnen i förväg, särskilt helger i juli.' }, { q: 'Kan man boka gästhamnsplats i förväg i skärgården?', a: 'Ja på många ställen – Marinas.com, Gästhamnar.se och respektive hamnkontor tar bokningar. Rekommenderas starkt för helger juni–augusti. Vardagar och i september går ofta bra att anlöpa utan bokning.' }] },
  { slug: "kraftskiva-hemma-2026", title: "Kräftskiva hemma 2026 – komplett guide till mat, dryck och stämning", excerpt: "Allt du behöver för att arrangera en perfekt kräftskiva hemma. Recept, inköpslista, dekorationer, snapsvisor och hur du lagar kräftorna rätt.", category: "Mat", emoji: "🦀", readTime: "9 min", fullContent: true, featured: true, faqs: [{ q: 'Hur många kräftor per person behöver man till kräftskiva?', a: '1,5–2 kg råkräftor per person, eller 800 g–1 kg kokta kräftor. Räkna 20–30 kräftor per person om de är mellanstor. Ha alltid lite mer – folk äter mer än de tror.' }, { q: 'Hur kokar man kräftor hemma?', a: 'Saltlag: 4 liter vatten, 120 g salt, 2 rejäla dillkronor per liter. Koka upp, lägg i kräftorna, låt koka 8 minuter. Stäng av och låt svalna i lagen i minst 4 timmar – gärna över natten. Servera med dill och citron.' }, { q: 'Var köper man kräftor inför kräftskivan?', a: 'ICA Maxi, Coop och specialfiskhandlare har kräftor kring premiären. Beställ helst 1–2 veckor i förväg från fiskhandlare – de tar emot förbeställningar. Turkiska och svenska kräftor kostar 150–350 kr/kg.' }] },
  { slug: "algblomning-2026", title: "Algblomning 2026 – allt du behöver veta om blågrönalger och bad", excerpt: "Algblomning dyker upp varje sommar i Östersjön och insjöar. Vad är det, är det farligt, hur vet du om det är säkert att bada och var kollar du aktuell status?", category: "Praktisk", emoji: "🌿", readTime: "7 min", fullContent: true, faqs: [{ q: 'Vad är algblomning och varför uppstår det?', a: 'Algblomning orsakas av cyanobakterier (blågrönalger) som exploderar i antal vid varmt, lugnt väder och hög närsalthalt. I Östersjön är det vanligast juli–september. Typisk syn: gröngult skum i vikar och längs stränder.' }, { q: 'Är algblomning farligt att bada i?', a: 'Kan vara farligt. Alger kan producera gifter (cyanotoxiner) som ger hudirritationer, magbesvär och i extremfall mer allvarliga symptom. Hundar är särskilt känsliga. Om vattnet ser grumligt gröngult ut – bada inte.' }, { q: 'Var kollar man aktuell algblomning 2026?', a: 'SMHI:s algportalen (smhi.se) uppdateras dagligen med rapporter längs hela kusten. Kommunernas miljöförvaltningar stänger badplatser vid farliga nivåer. Kolla också Badplatsen-appen för lokala rapporter.' }] },
  { slug: "eldningsforbud-skargarden", title: "Eldningsförbud i skärgården – regler, var du kollar och vad som gäller", excerpt: "Eldningsförbud i skärgården och längs kusten ändras snabbt vid torrperioder. Hur du kollar aktuellt läge, vilka regler gäller och vad du får göra.", category: "Praktisk", emoji: "🔥", readTime: "6 min", fullContent: true, faqs: [{ q: 'Var kollar man aktuellt eldningsförbud i skärgården?', a: 'Länsstyrelsens hemsida för respektive region (Stockholm, Västra Götaland, Blekinge etc.) publicerar eldningsförbud. MSB:s brandriskkartan på msb.se visar aktuell brandrisk. Kolla alltid innan du åker ut.' }, { q: 'Gäller eldningsförbud engångsgrillar på stranden?', a: 'Ja – vid eldningsförbud är engångsgrillar, öppen eld och rökande förbjudet. Gasolgrill i gästhamn/bekväm markyta kan vara undantagen beroende på förbudet. Läs det specifika förbudets text.' }, { q: 'Vad händer om man eldar under eldningsförbud?', a: 'Böter och i allvarliga fall åtal. Om du orsakar en brand under eldningsförbud kan du bli skadeståndsskyldig för brandkostnader – som kan uppgå till miljoner kronor. Rapportera olaglig eldning till 112.' }] },
  { slug: "bat-nybörjare-guide", title: "Första båtturen i skärgården – komplett guide för nybörjare", excerpt: "Aldrig varit ute med båt i skärgården? Här är allt du behöver veta: vad du packar, hur du navigerar, vad du får och inte får göra och hur du hittar rätt hamn.", category: "Praktisk", emoji: "⛵", readTime: "10 min", fullContent: true, faqs: [{ q: 'Behöver man körkort för att köra båt i skärgården?', a: 'Inget lagkrav för fritidsbåt. Men du bör kunna grundläggande sjösäkerhet, regler och navigation. Fritidsskepparexamen (kurs via SSRS eller privata skolor) rekommenderas för havstur. Hyrbåtsbolag kräver ofta intyg för större båtar.' }, { q: 'Vad packar en nybörjare inför båttur i skärgården?', a: 'Flytväst (obligatorisk bra att ha på sig), karta/sjökort eller app (Navionics, Garmin ActiveCaptain), regnkläder, mat och vatten för en dag extra, nödraketer vid längre tur, telefon laddad och VHF-radio.' }, { q: 'Vad kostar det att hyra båt för en dag i Stockholms skärgård?', a: 'Hyrbåtar för nybörjare (elbåt, liten motorbåt): 500–1 500 kr/dag. Segelbåt: 1 500–5 000 kr/dag beroende på storlek. Tillkommer drivmedel för motorbåtar. Elektriska båtar är populärast bland nybörjare.' }] },
  { slug: "gasthamnar-bohuslan-2026", title: "Bästa gästhamnarna i Bohuslän 2026 – Smögen, Marstrand och Koster", excerpt: "En guide till de bästa gästhamnarna längs Bohusläns kust. Priser, faciliteter, mat i närheten och hur du bokar plats under högsäsong.", category: "Praktisk", emoji: "⚓", readTime: "9 min", fullContent: true, faqs: [{ q: 'Vad kostar gästhamn i Bohuslän?', a: 'Priser 2026: Smögen 250–400 kr/natt, Marstrand 300–500 kr/natt, Grebbestad 200–350 kr/natt. El ca 50–100 kr extra. Kosteröarnas hamn har några av de bäst ryktet längs kusten.' }, { q: 'Vilken gästhamn i Bohuslän passar nybörjaren bäst?', a: 'Lysekil och Grebbestad har stora, välordnade gästhamnar med bra service och enkla inlopp. Smögen är populärt men trängre. Marstrand är välskyddat och har alltid plats i hamnen.' }, { q: 'Är gästhamnarna i Bohuslän öppna i september?', a: 'De flesta håller öppet till och med september, och flera till oktober. Smögen, Marstrand och Lysekil har personal och service hela hösten. Kolla respektive hamns hemsida för exakta datum.' }] },
]
