...
export const GUIDES: GuideMeta[] = [
  ...
  },
  {
    ...
    fullContent: true,
    faqs: [
      { q: 'Hur tar man sig till Sandhamn?', a: 'Snabbaste vägen: SL-buss 433 från Slussen till Stavsnäs (ca 55 min) och sedan Waxholmsbolagets båt till Sandhamn (ca 35–60 min). Alternativt Cinderellabåten direkt från Strandvägen (ca 2,5 h). Cinderellabåten kräver bokning under högsäsong.' },
      ...
      // KÄLLA: Strömma, Båt till Sandhamn — "from SEK 255" för enkel resa; något returpris publiceras inte på sidan — https://www.stromma.com/en-se/stockholm/excursions/day-trips/sandhamn/ (läst 2026-09-17)
      // Stod "Ca 350-450 kr tur/retur beroende på säsong" — det spannet finns inte publicerat någonstans.
      { q: 'Vad kostar Cinderellabåten till Sandhamn?', a: 'Strömma anger från 255 kr för enkel resa. Returpriset varierar med avgång och publiceras inte som en fast siffra — se stromma.com för din dag. Cinderellabåten ingår inte i Waxholmsbolagets ordinarie sortiment utan är en separat produkt som drivs av Strömma.' },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "Säsong", emoji: "🍤", readTime: "7 min", fullContent: true,
    faqs: [
      { q: 'Vilka är de bästa restaurangerna i Stockholms skärgård?', a: 'Sandhamns Värdshus, Utö Värdshus, Grinda Wärdshus och Finnhamns vandrarhem (enkel men god mat) toppar listan. Möjas restaurang och Waxholms Hotell är också klassiker. Boka bord minst 2–3 veckor i förväg för juli.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'Vilken är den bästa campingen på Gotland?', a: 'Tofta Camping är Gotlands populäraste familjecamping med direktläge vid Tofta strand — en av öns vackraste sandstränder. Sudersand Resort på Fårö är det vackraste läget med fantastiska raukar nära. Kneippbyn Resort söder om Visby passar familjer med höga krav på service och aktiviteter.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'Vilken är den bästa campingen i Bohuslän?', a: 'GrebbestadFjorden passar den som vill ha genuint fiskesamhällsliv.' },
  ...
  },
  {
    ...
    title: "Snorkling i Kosterhavet – 6 000 arter under ytan",
    excerpt: "Kosterhavets nationalpark har omkring 6 000 marina arter, närmare 300 av dem finns bara här i Sverige. Sjöborrar, sjöstjärnor och koraller väntar under ytan. Guide till snorkling och dykning.",
    category: "Aktivitet", emoji: "🤿", readTime: "7 min", fullContent: true,
    faqs: [
  ...
  { slug: "barnfamilj-stockholms-skargard", title: "De bästa öarna i Stockholms skärgård med barn", excerpt: "Stockholms skärgård med barn behöver inte vara komplicerat. Guide till de barnvänligaste öarna – sandstränder, korta resor och öar där det händer saker.", category: "Praktisk", emoji: "👨‍👩‍👧", readTime: "7 min", fullContent: true, faqs: [{ q: 'Vilken ö i Stockholms skärgård passar bäst med barn?', a: 'Fjäderholmarna är det enklaste valet – ca 25 min från Strandvägen, grunt vatten och hantverksgallerier. Tre rederier trafikerar ön: Strömma från Strandvägen, Fjäderholmslinjen från Slussen och Waxholmsbolaget från Strömkajen — kolla vilken biljett som gäller för den avgång du väljer. Grinda är bäst för familjer som vill stanna ett dygn – sandstrand, Wärdshuset och lugn natur.' }, { q: 'Finns det öar med sandstrand nära Stockholm?', a: 'Grinda har en fin sandig badvik. Sandön (nära Djurö) är känt för sin sandstrand. Arholma i norra skärgården har sandstrand och bekräftad lekplats. Dalarö i söder har grunda och skyddade vikar.' }, { q: 'Hur långa båtresor klarar barn i skärgården?', a: 'De flesta barn klarar 45–60 min bra med mat och dryck ombord. Fjäderholmarna (25 min) och Vaxholm (ca 55 min) är perfekta startalternativ. Sandhamn och Utö kräver 2+ timmar och passar bättre för barn från ca 5 år.' }] },
