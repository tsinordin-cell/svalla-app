...
export const GUIDES: GuideMeta[] = [
  ...
  // ── Batch K ────────────────────────────────────────────────────────────────
  { slug: "varmdo-guide", title: "Värmdö – guide till Stockholms närmaste skärgårdsö", excerpt: "Värmdö är Stockholms närmaste riktiga skärgårdsupplevelse. Öar, badvikar, vandringsleder och restauranger – allt nåbart på under en timme från city.", category: "Destination", emoji: "🏝", readTime: "8 min", fullContent: true },
  ...
  { slug: "aspo-sturko-guide", title: "Aspö och Sturkö – Blekinges vackraste öar", excerpt: "Aspö och Sturkö utanför Karlskrona är Blekinges skärgårds pärlor. Sandstränder, fågelrika stränder och en avslappnad öatmosfär utan trängsel.", category: "Destination", emoji: "🏝", readTime: "6 min", fullContent: true },
  { slug: "trysunda-guide", title: "Trysunda – Höga Kustens pärla", excerpt: "Trysunda är en av Höga Kustens mest kända öar med ett av Sveriges bäst bevarade fiskelägen. En guide till ön och hur du tar dig dit.", category: "Destination", emoji: "🏝", readTime: "6 min", fullContent: true },
  { slug: "skafto-guide", title: "Skaftö – guide till Fiskebäckskil och Grundsund", excerpt: "Skaftö är en stor Bohuslänsö med dramatisk klippkust, charmiga fiskbyar och ett lugn som sommarstämpeln inte förstör.", category: "Destination", emoji: "🏝", readTime: "7 min", fullContent: true },
  { slug: "holmon-guide", title: "Holmön – guide till Umeås skärgård", excerpt: "Holmön är Bottenhavets bilfria ö utanför Umeå. Norr om den vanliga semesterkartan, men med en natur och stämning som är unik i Sverige.", category: "Destination", emoji: "🏝", readTime: "6 min", fullContent: true },
