  ...
  return (
    <>
      ...
      <div role="dialog" aria-modal="true" aria-label="Redigera profil" style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 900, background: 'var(--white)', borderRadius: '24px 24px 0 0', maxWidth: 520, margin: '0 auto', boxShadow: '0 -4px 40px rgba(0,45,60,0.18)', maxHeight: '92dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* Spara-knappar: flex-item direkt i dialog-kolumnen — syns alltid
            nedanför scroll-området oavsett Safari-toolbar, tangentbord eller skärmstorlek.
            (Tidigare sticky inuti scroll-container fungerade inte när innehållet var kort.) */}
        <div style={{
          flexShrink: 0,
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', paddingBottom: 'calc(var(--nav-h) + env(safe-area-inset-bottom,0px) + 24px)' }}>
      ...
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '0 16px' }}>
        ...
        {/* ── Shortcuts: Sparade platser + Mina rutter ── */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
          <Link href="/sparade" style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--txt)' }}>Sparade platser</div>
              <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>Krogar & bryggor</div>
            </div>
          </Link>
          <Link href="/planera" style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--txt)' }}>Mina rutter</div>
              <div style={{ fontSize: 11, color: 'var(--txt3)', marginTop: 2 }}>Planera & spara</div>
            </div>
          </Link>
        </div>
