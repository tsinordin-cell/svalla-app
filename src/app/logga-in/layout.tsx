...
/**
 * Inloggningssidan är robots-blockerad men Google hade ändå indexerat den — troligen
...
export default function LoggaInLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>
}
