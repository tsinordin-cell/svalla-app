    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg, #f7fbfc)', paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 20px' }}>
        <article style={{ background: 'var(--white, #fff)', borderRadius: 16, padding: '36px 32px', boxShadow: '0 2px 16px rgba(0,0,0,0.06)', lineHeight: 1.75, color: 'var(--txt2, #2a4a5a)', fontSize: 15 }}>
          ...
          <h2 style={{ color: 'var(--txt, #162d3a)', fontSize: 18 }}>3. Hur vi använder dina uppgifter</h2>
          ...
          <h2 style={{ color: 'var(--txt, #162d3a)', fontSize: 18 }}>4. Rättslig grund</h2>
          ...
          <h2 style={{ color: 'var(--txt, #162d3a)', fontSize: 18 }}>5. Lagring och säkerhet</h2>
          ...
          <h2 style={{ color: 'var(--txt, #162d3a)', fontSize: 18 }}>6. Dina rättigheter</h2>
          <p>Du har rätt att:</p>
          <ul>
