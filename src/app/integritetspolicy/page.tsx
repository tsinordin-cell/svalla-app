  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7fbfc', paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 20px' }}>
        <article style={{ background: '#fff', borderRadius: 16, padding: '36px 32px', boxShadow: '0 2px 16px rgba(0,0,0,0.06)', lineHeight: 1.75, color: '#2a4a5a', fontSize: 15 }}>

          <h2 style={{ color: '#162d3a', fontSize: 18, marginTop: 0 }}>1. Personuppgiftsansvarig</h2>
          <p>Svalla (svalla.se) är personuppgiftsansvarig för behandlingen av dina personuppgifter. Kontakta oss på <a href="mailto:hej@svalla.se" style={{ color: '#1e5c82' }}>hej@svalla.se</a> vid frågor.</p>

          <h2 style={{ color: '#162d3a', fontSize: 18 }}>2. Vilka uppgifter vi samlar in</h2>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 18 }}>3. Hur vi använder dina uppgifter</h2>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 18 }}>4. Rättslig grund</h2>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 18 }}>5. Lagring och säkerhet</h2>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 18 }}>6. Dina rättigheter</h2>
          <p>Du har rätt att:</p>
          <ul>
          ...
          <p>Kontakta <a href="mailto:hej@svalla.se" style={{ color: '#1e5c82' }}>hej@svalla.se</a> för att utöva dina rättigheter.</p>

          <h2 style={{ color: '#162d3a', fontSize: 18 }}>7. Cookies</h2>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 18 }}>8. Kontakt</h2>
          <p>Frågor om vår integritetspolicy? Hör av dig till <a href="mailto:hej@svalla.se" style={{ color: '#1e5c82' }}>hej@svalla.se</a>.</p>
