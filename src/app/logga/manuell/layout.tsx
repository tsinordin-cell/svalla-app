...
/**
 * Manuell loggning är robots-blockerad men Google hade ändå indexerat den — troligen
...
export default function LoggaManuellLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>
}
