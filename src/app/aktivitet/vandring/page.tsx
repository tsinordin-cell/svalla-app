...
export const metadata: Metadata = {
  title: { absolute: 'Vandring i skärgården — kustleder, öar och tips | Svalla' },
...
const TOP_10 = [
  ...
  { rank: 4, name: 'Nordkoster, Kosterhavet', region: 'Bohuslän', desc: 'Sveriges enda marina nationalpark. Dramatiska klippor och Västerhavet i alla riktningar. Bilfri ö med välmarkerade leder.', slug: '/aktivitet/vandring/nordkoster' },
        ...
        <main style={{ maxWidth: 900, margin: '-24px auto 0', padding: '0 16px 80px' }}>
          ...
          <div style={{ marginTop: 16 }}>
            <EmailSignup
              ...
              description="Nya guider, säsongstips och insidertips direkt i mailen. 2 mail i månaden."
            />
          </div>
