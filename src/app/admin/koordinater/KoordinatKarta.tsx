...
// Skärgårdscentrum — Stockholms skärgård (mitt mellan Stockholm och Sandhamn)
// FIXAT 2026-04-25: tidigare 18.85 låg redan ute på Möja, för långt öster ut
const DEFAULT_CENTER: [number, number] = [59.35, 18.5]
const DEFAULT_ZOOM = 9
// Bounds förhindrar pan till Åbolands skärgård eller Norge
const STOCKHOLM_ARCHIPELAGO_BOUNDS: [[number, number], [number, number]] = [
  [58.5, 17.5], // SW: söder om Landsort, väster om Stockholm
  [60.1, 19.8], // NE: norr om Arholma, öster om Söderarm
]
  ...
  useEffect(() => {
    ...
    import('leaflet').then(L => {
      ...
      const map = L.map(mapRef.current!, {
        ...
        zoom: DEFAULT_ZOOM,
        maxBounds: STOCKHOLM_ARCHIPELAGO_BOUNDS,
