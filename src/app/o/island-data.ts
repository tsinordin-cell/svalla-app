...
export const ISLANDS: Island[] = [
  ...
  // ─── VAXHOLM ─────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Hamnkrogen Vaxholm',
        type: 'Restaurang',
        desc: 'Klassisk bryggkrog med räkor och husmanskost direkt vid Vaxholms hamn. Utsikt mot fästningen.',
        price_example: 'Räksmörgås 195–235 kr, varmrätt 195–285 kr',
        open_season: 'Maj–September',
        open_hours: 'Mån–fre 11–21, lör–sön 11–22 (sommartid)',
      },
      {
        name: 'Winbergs Kök & Bar',
        type: 'Restaurang',
        desc: 'Enkel och bra mat i avslappnad miljö mitt i Vaxholms centrum.',
        price_example: 'Lunch 145–185 kr, middag 195–265 kr',
        open_season: 'Hela året',
        slug: 'winbergs-kok-bar',
      },
      {
        name: 'Getfoten Sjökrog',
        type: 'Restaurang',
        desc: 'Populär sjökrog söder om stan vid vattnet. Säsongsbetonad meny med lokala råvaror.',
        price_example: 'Räksmörgås 225–265 kr, à la carte 245–365 kr',
        open_season: 'Juni–Augusti',
        book_required: true,
        book_note: 'Boka bord på helger i juli',
        slug: 'getfoten-sjokrog',
      },
      { name: 'Mathantverkstan', type: 'Delikatess', desc: 'Rökt fisk och lokalt producerade skafferivaror — perfekt för matsäck ut i skärgården.' },
    ],
    day_cost: {
      budget_per_person: '300–650 kr',
      includes: 'Båt eller buss + lunch + fika',
      breakdown: [
        { item: 'Buss 670 Stockholm–Vaxholm tur & retur (SL)', price: 'Ingår i SL-kort / ca 60 kr' },
        { item: 'Lunch på Hamnkrogen (varmrätt)', price: 'ca 195–235 kr' },
        { item: 'Kaffe och kaka', price: 'ca 60–80 kr' },
        { item: 'Glass vid kajen', price: 'ca 40–60 kr' },
        { item: 'Eventuellt inträde Kastell-museet', price: 'ca 80 kr (vuxen)' },
      ],
      tips: [
        'Buss 670 med SL-kort är billigaste alternativet — snabbare än båten och lika mysigt.',
        'Fästningen syns gratis utifrån vattnet — inträde om du vill gå in.',
        'Köp med rökt lax från Mathantverkstan och ät på kajen istället för restaurang.',
      ],
    },
    tips: [
    ...
    restaurants: [
      {
        name: 'Finnhamns Krog',
        type: 'Restaurang',
        desc: 'Samlingsplatsen vid hamnen. Säsongsbaserad meny med enkel, ärlig skärgårdsmat — soppa, fiskrätter och husmansklassiker.',
        price_example: 'Lunch 145–185 kr, middag 195–265 kr',
        open_season: 'Juni–Augusti dagligen, maj & sept veckoslut',
        open_hours: 'Lunch 12–15, middag 18–21',
        bookingUrl: 'https://www.bokabord.se/restaurang/finnhamns-krog',
        websiteUrl: 'https://finnhamn.se',
      },
      {
        name: 'Takbaren',
        type: 'Bar',
        desc: 'Bar med panoramautsikt från vandrarhemsbyggnadens tak. Öl, cider och enkla snacks.',
        price_example: 'Fatöl ca 85–95 kr, drinkar 95–125 kr',
        open_season: 'Juni–Augusti',
        open_hours: 'Från 15:00 dagligen',
      },
      { name: 'Ragnars kiosk', type: 'Kiosk', desc: 'Glassbod och enkla tilltugg vid bryggan. Öppnar när båten kommer.', slug: 'ragnars-kiosk-finnhamn' },
      { name: 'Lanthandeln', type: 'Handel', desc: 'Proviant, kaffe och metmask. Allt du behöver.' },
    ],
    day_cost: {
      budget_per_person: '350–650 kr',
      includes: 'Båt tur & retur + lunch + öl',
      breakdown: [
        { item: 'Waxholmsbåt Stockholm–Finnhamn tur & retur', price: 'ca 270–310 kr' },
        { item: 'Lunch på Finnhamns Krog', price: 'ca 145–185 kr' },
        { item: 'Öl på Takbaren', price: 'ca 85–95 kr' },
        { item: 'Glass vid kiosken', price: 'ca 45–60 kr' },
      ],
      tips: [
        'Finnhamn är ett av de billigaste heldagsmålen i skärgården — krogen är enkel och prisvänlig.',
        'Ta med matsäck och spara 150+ kr — klipporna och skogen är gratis och underbar.',
        'Vandrarhemsboende från ca 350 kr/natt — kombinera dagstur med övernattning.',
      ],
    },
    tips: [
  ...
  // ─── MÖJA ────────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Möja Värdshus & Bageri',
        type: 'Värdshus/Bageri',
        desc: 'Öns hjärta i Kyrkviken sedan 1951. Nybakt bröd varje morgon från 7:00, lunch och restaurang med utsikt mot vattnet. Husmanskost med lokala råvaror.',
        price_example: 'Frukost/fika 60–120 kr, lunch 165–215 kr, middag 195–285 kr',
        open_season: 'Maj–September',
        open_hours: 'Bageri öppnar 07:00, restaurang lunch 12–14, middag 18–20',
        websiteUrl: 'https://mojavardshusochbageri.se',
      },
      { name: 'Wikströms fisk', type: 'Handel', desc: 'Färsk fisk och räkor direkt från fiskaren vid hamnen. Öppet under sommarsäsongen när fångsten är inne.' },
      { name: 'Möja Lanthandel', type: 'Handel', desc: 'Proviant och dagligvaror. Öppen hela året — en av de bättre sorterade lanthandelarna i skärgården.' },
    ],
    day_cost: {
      budget_per_person: '500–850 kr',
      includes: 'Båt tur & retur + lunch + fika',
      breakdown: [
        { item: 'Waxholmsbåt Strömkajen–Möja tur & retur', price: 'ca 310–360 kr' },
        { item: 'Lunch på Möja Värdshus', price: 'ca 165–215 kr' },
        { item: 'Fika och bröd från bageriet', price: 'ca 60–90 kr' },
        { item: 'Räkor från Wikströms (halvkilo)', price: 'ca 120–160 kr' },
      ],
      tips: [
        'Köp räkor direkt från Wikströms vid hamnen och ät på en klippa — billigare och godare än restaurang.',
        'Bageriet öppnar 7:00 — de som vill ha nybakat bröd till frukost tar morgonbåten.',
        'Cykelhyrning vid Berg ger tillgång till hela öns 12 km — värt de extra kronorna.',
      ],
    },
    tips: [
  ...
  // ─── LJUSTERÖ ─────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Linanäsbryggan',
        type: 'Restaurang',
        desc: 'Klassisk brygga vid Linanäs med skärgårdsmat och havsutsikt. Populärt utflyktsmål för both seglare och cyklister.',
        price_example: 'Räkor 195–265 kr, grillat 175–235 kr, fika 65–85 kr',
        open_season: 'Juni–Augusti',
        open_hours: '11–21',
        book_required: false,
        child_menu: true,
      ...
      {
        name: 'Klintan Sjöstation',
        type: 'Service/Kafé',
        desc: 'Bränsle, kaffe och enkla tilltugg vid Klintan — naturlig samlingspunkt för seglare. Sjömack med full service.',
        slug: 'klintan-sjostation',
        price_example: 'Kaffe 40–55 kr, smörgås 75–95 kr',
        open_season: 'Juni–Augusti',
        open_hours: '08–18',
      },
      {
        name: 'Pizzeria Ljusterö',
        type: 'Restaurang',
        desc: 'Lokalbefolkningens val — avslappnat, generösa portioner och bra pris. Populärt för familjer och de som vill ha ett riktigt mål.',
        slug: 'pizzeria-ljustero',
        price_example: 'Pizza 105–155 kr, pasta 115–145 kr',
        open_season: 'Helår',
        open_hours: '11–21',
        child_menu: true,
      },
    ...
    day_cost: {
      ...
      includes: 'Buss + avgiftsfri bilfärja t/r, lunch vid bryggan och fika.',
      breakdown: [
        [
          { item: 'Buss 621 + bilfärja (avgiftsfri) t/r', price: '60–100 kr (SL)' },
          { item: 'Cykeluthyrning (halvdag)', price: '100–150 kr' },
          { item: 'Lunch vid Linanäsbryggan', price: '175–265 kr' },
          { item: 'Kaffe, Klintan', price: '40–55 kr' },
        ],
      ],
      tips: [
        'Tar du bil till Östanå är bilfärjan gratis — betala bara SL-avgiften eller kör hela vägen.',
        'Cykelrunda norrut mot Linanäs (ca 15–20 km t/r) med lunch vid bryggan är klassisk Ljusterö-dag.',
        'Klintan har bränsle — bra stopp för seglare på väg norrut mot Arholma eller Furusund.',
      ],
    },
    tips: [
    ...
    restaurants: [
      {
        name: 'Dalarö Krog',
        type: 'Restaurang',
        desc: 'Klassisk hamnkrog med husmanskost och räkor vid Dalarös hamn. Klassisk skärgårdsmat i välbevarad miljö.',
        price_example: 'Räksmörgås 195–245 kr, varmrätt 185–265 kr',
        open_season: 'April–Oktober',
        open_hours: 'Lunch 12–15, middag 18–21 (sommartid)',
      },
      {
        name: 'Dalarö Värdshus',
        type: 'Restaurang',
        desc: 'Anrikt värdshus med god mat och historia. Ligger i ett av Dalarös äldsta hus — havsutsikt och klassisk atmosfär.',
        price_example: 'Lunch 175–235 kr, middag 225–345 kr',
        open_season: 'Maj–September',
        book_required: true,
        book_note: 'Boka bord i förväg på sommaren',
      },
      { name: 'Dalarö Bageri & Café', type: 'Bageri', desc: 'Morgonkaffet och nybakade bullar. Öppnar tidigt — perfekt innan promenaden mot Skansen.', price_example: 'Fika 55–85 kr' },
    ],
    day_cost: {
      budget_per_person: '250–550 kr',
      includes: 'Bil eller kollektivt + lunch + fika',
      breakdown: [
        { item: 'Buss + pendeltåg (SL-kort) eller bil (bensin ca)', price: 'SL-kort eller ca 80–120 kr bensin' },
        { item: 'Lunch på Dalarö Krog', price: 'ca 185–245 kr' },
        { item: 'Kaffe och bulle på bageriet', price: 'ca 55–85 kr' },
        { item: 'Inträde Dalarö Skans (frivilligt)', price: 'gratis att se utifrån' },
      ],
      tips: [
        'Dalarö är ett av de billigaste heldagsmålen i södra skärgården — bil dit är snabbt och enkelt.',
        'Kombinera med pendelbåten vidare till Utö (avgår från Dalarö hamn) för en fullständig södradag.',
        'Dalarö Skans + bad + lunch håller en full dag utan att man behöver lägga mer än 300 kr.',
      ],
    },
    tips: [
  ...
  // ─── ARHOLMA ─────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Arholma Dansbana & Krog',
        type: 'Restaurang',
        desc: 'Öns krog och samlingspunkt. Enkel mat med säsongsbetonad meny — fisk, räkor och husmanskost. Dansbana på sommaren.',
        price_example: 'Räksmörgås 185–235 kr, varmrätt 185–265 kr',
        open_season: 'Juni–Augusti',
        open_hours: 'Lunch 12–15, middag 18–21',
        slug: 'arholma-dansbana-krog',
      },
      {
        name: 'Arholma Hamnkrog',
        type: 'Restaurang',
        desc: 'Hamnkrogen för seglare vid gästhamnen. Enkla rätter, öl och snacks till rimliga priser.',
        price_example: 'Räksmörgås 175–215 kr, öl ca 80–95 kr',
        open_season: 'Juni–Augusti',
      },
    ],
    day_cost: {
      budget_per_person: '500–900 kr',
      includes: 'Båt/bil + färja + mat',
      breakdown: [
        { item: 'Waxholmsbåt Norrtälje–Arholma tur & retur', price: 'ca 200–250 kr' },
        { item: 'Lunch på Dansbana & Krog', price: 'ca 185–235 kr' },
        { item: 'Öl och snacks på Hamnkrogen', price: 'ca 95–140 kr' },
        { item: 'Glass och fika', price: 'ca 50–80 kr' },
      ],
      tips: [
        'Arholma kräver planering — kolla Waxholmsbåtens tidtabell från Norrtälje i förväg.',
        'Alternativt: kör till Simpnäs och ta passagerarfärjan (15 min) — snabbare och billigare.',
        'Det finns inget att köpa i butiker på kvällen — ta med matsäck om du kommer sent.',
      ],
    },
    tips: [
  ...
  // ─── ORNÖ ─────────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Kyrkviken Bar & Bistro',
        type: 'Restaurang',
        desc: 'Öns samlingsplats vid kyrkviken. Husmanskost, lokalt fångad fisk och sommarstämning vid vattnet.',
        slug: 'kyrkviken-bar-bistro',
        price_example: 'Fiskrätt 165–225 kr, hamburgare 145–185 kr, räksmörgås 175 kr',
        open_season: 'Juni–Augusti',
        open_hours: '11–21',
        book_required: false,
        book_note: 'Lugnt läge — sällan fullt, men kontrollera öppettider.',
        child_menu: true,
      },
      {
        name: 'Ornö Brödbod o Deli',
        type: 'Deli',
        desc: 'Surdegsbröd, lokalproducerade råvaror och enkel lunch. Bra för vandrarens matsäck.',
        price_example: 'Bröd 45–75 kr, delikatesssmörgås 95–125 kr',
        open_season: 'Juni–Augusti',
        open_hours: '09–14',
      },
    ],
    day_cost: {
      budget_per_person: '300–600 kr',
      includes: 'Bilfärja Dalarö t/r (bil eller fot), lunch på bistron och proviant.',
      breakdown: [
        [
          { item: 'Ornö Sjötrafik t/r (fotgängare)', price: '80–120 kr' },
          { item: 'Lunch, Kyrkviken Bar & Bistro', price: '145–225 kr' },
          { item: 'Bröd + delikatess, Brödbod', price: '95–125 kr' },
          { item: 'Kaffe / övrigt', price: '40–60 kr' },
        ],
      ],
      tips: [
        'Ta cykel med på bilfärjan — ön är lättcyklad och du ser mycket mer än till fots.',
        'Kombinera med Dalarö (utgångspunkt) och Utö för ett helgprogram i södra skärgården.',
        'Ornö kyrka från 1200-talet tar 15 min att besöka — öppen sommartid, gratis.',
      ],
    },
    tips: [
  ...
  // ─── LANDSORT ────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Saltboden Kök & Proviant',
        type: 'Handel/Restaurang',
        desc: 'Öns enda matplats — enkel husmanskost, smörgåsar och proviant. Stänger tidigt. Ta alltid med extra mat.',
        slug: 'saltboden-kok-proviant',
        price_example: 'Räksmörgås 145–185 kr, soppa 115–145 kr, kaffe + bulle 65 kr',
        open_season: 'Juni–Augusti',
        open_hours: '10–17',
        book_required: false,
        book_note: 'Begränsat sittplatser utomhus — kom tidigt på dagen.',
      },
      {
        name: 'Landsort Hamncafé',
        type: 'Café',
        desc: 'Kaffe och smörgåsar vid hamnen. Enkel service för seglare som lägger till.',
        price_example: 'Kaffe 40–55 kr, smörgås 75–105 kr',
        open_season: 'Juli–Mitten av Augusti',
        open_hours: '09–15',
      },
    ],
    day_cost: {
      budget_per_person: '400–750 kr',
      includes: 'Tåg Nynäshamn + skärgårdsbåt t/r, lunch vid Saltboden och proviant.',
      breakdown: [
        [
          { item: 'SL-tåg Stockholm–Nynäshamn t/r', price: '145–200 kr' },
          { item: 'Skärgårdsbåt Nynäshamn–Landsort t/r', price: '120–180 kr' },
          { item: 'Lunch, Saltboden', price: '115–185 kr' },
          { item: 'Kaffe + fika', price: '65–80 kr' },
          { item: 'Extra proviant', price: '60–100 kr' },
        ],
      ],
      tips: [
        'Ta med rejäl matsäck — Saltboden stänger 17 och variationen är begränsad.',
        'Kolla vädret NOGGRANT dagen innan — Landsort är helt exponerat mot öppet Östersjön.',
        'Fågelstationen är gratis att besöka. Bäst under sträcktiderna april–maj och aug–okt.',
      ],
    },
    tips: [
  ...
  // ─── FURUSUND ────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Furusund Värdshus',
        type: 'Restaurang',
        desc: 'Anrikt värdshus med restaurang sedan 1950 — anlagd i det gamla 1800-talstullhuset vid sundet. Säsongsbetonad mat med maritim prägel.',
        slug: 'furusund-vardshus',
        price_example: 'Lunch 145–195 kr, middag 225–345 kr, räksmörgås 195 kr',
        open_season: 'Maj–Oktober',
        open_hours: 'Lunch 12–15, middag 17–21',
        book_required: true,
        book_note: 'Boka middag i förväg under juli — populärt stopp för seglare.',
        phone: '0176-208 90',
        child_menu: true,
      },
    ],
    day_cost: {
      ...
      includes: 'Bil (bensin) eller Waxholmsbåt t/r, lunch och middag på värdshuset.',
      breakdown: [
        [
          { item: 'Bensin t/r Stockholm (ca 24 mil)', price: '150–200 kr/bil' },
          { item: 'Lunch, Furusund Värdshus', price: '145–195 kr' },
          { item: 'Middag, Furusund Värdshus', price: '225–345 kr' },
          { item: 'Kaffe / övrigt', price: '50–80 kr' },
        ],
      ],
      tips: [
        'Kom med bil om du vill kombinera med Blidö och norra skärgårdens övriga öar.',
        'Värdshuset är bäst på kvällen — boka i förväg och hämta upplevelsen av sundet i solnedgångljus.',
        'Kajakuthyrning finns vid hamnen i juli — paddla ut mot holmarna kring sundet.',
      ],
    },
    tips: [
  ...
  // ─── BLIDÖ ────────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Blidö Brygga & Bistro',
        type: 'Restaurang',
        desc: 'Öns samlingspunkt vid bryggan — enkel skärgårdsmat, välkommen bland båtfolk och cyklister.',
        slug: 'blido-brygga-bistro',
        price_example: 'Hamburgare 145–175 kr, fiskrätt 165–215 kr, kaffe 45 kr',
        open_season: 'Juni–Augusti',
        open_hours: '11–20',
        book_required: false,
        child_menu: true,
      },
      {
        name: 'Blidö Värdshus',
        type: 'Restaurang',
        desc: 'Klassiskt värdshus på ön med säsongsbetonad meny. Lugnare stämning än bistron vid bryggan.',
        price_example: 'Lunch 145–185 kr, middag 195–285 kr',
        open_season: 'Juni–Augusti',
        open_hours: 'Lunch 12–15, middag 17–21',
        book_required: true,
        book_note: 'Boka middag i förväg under högsäsong.',
        child_menu: true,
      },
    ],
    day_cost: {
      budget_per_person: '300–600 kr',
      includes: 'Bil + bilfärja t/r, lunch på bistron och cykeltur.',
      breakdown: [
        [
          { item: 'Bilfärja Vätö–Blidö t/r (per person)', price: '80–120 kr' },
          { item: 'Cykeluthyrning (halvdag)', price: '100–140 kr' },
          { item: 'Lunch, Blidö Brygga & Bistro', price: '145–215 kr' },
          { item: 'Kaffe + fika', price: '45–65 kr' },
        ],
      ],
      tips: [
        'Kombinera Blidö med Furusund på samma bil-och-bilfärja-tur — 30 min emellan.',
        'Hyr cykel vid bryggan — öns grusvägar är nästan bilfria och tar dig genom vacker norra skärgård.',
        'Blidö Värdshus är bäst för middag — boka bordet redan hemma.',
      ],
    },
    tips: [
  ...
  // ─── GÄLLNÖ ──────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Gällnö Bar',
        type: 'Bar',
        desc: 'Enkel bar vid hamnen — öl, läsk och enkla tilltugg. Öppet sommarsäsong. Inte mer, inte mindre.',
        slug: 'gallno-bar',
        price_example: 'Öl 65–85 kr, läsk 35 kr, macka 75–95 kr',
        open_season: 'Juli–Mitten av Augusti',
        open_hours: '12–19',
      },
      {
        name: 'Gällnö Handelsbod',
        type: 'Handel',
        desc: 'Proviant och enkla drycker. Ladda på inför vandringen i reservatet.',
        price_example: 'Konserver, bröd och dryck — ca 80–150 kr per person',
        open_season: 'Juni–Augusti',
        open_hours: '10–17',
      },
    ],
    day_cost: {
      ...
      includes: 'Waxholmsbåt från Stavsnäs t/r, enkla inköp och fika.',
      breakdown: [
        [
          { item: 'Waxholmsbåt Stavsnäs–Gällnö t/r', price: '100–150 kr' },
          { item: 'Handelsboden — proviant', price: '80–150 kr' },
          { item: 'Gällnö Bar — dryck', price: '65–95 kr' },
        ],
      ],
      tips: [
        'Ta alltid med matsäck — Gällnö är ett naturreservat med minimal service.',
        'Gällnö är ett utmärkt ankarstopp, inte en heldagsdestination i sig. Kombinera med Möja eller Sandhamn.',
        'Ljunghedarna i sensommaren (slutet av juli–aug) är öns absoluta höjdpunkt — planera dit.',
      ],
    },
    tips: [
    ...
    restaurants: [
      {
        name: 'Norröra Krog',
        type: 'Restaurang',
        desc: 'Öns lilla krog — enkel husmanskost sommartid. Atmosfär av "Saltkråkan"-idyll med bryggutsikt.',
        price_example: 'Enkel lunch 125–165 kr, kaffe + bulle 65 kr',
        open_season: 'Juni–Augusti',
        open_hours: '11–17',
        book_required: false,
        book_note: 'Liten krog — begränsat antal platser.',
        child_menu: true,
      },
    ],
    day_cost: {
      budget_per_person: '450–750 kr',
      includes: 'Waxholmsbåt från Norrtälje t/r, lunch och enkla inköp.',
      breakdown: [
        [
          { item: 'Waxholmsbåt Norrtälje–Norröra t/r', price: '150–200 kr' },
          { item: 'Lunch, Norröra Krog', price: '125–165 kr' },
          { item: 'Kaffe + fika', price: '65 kr' },
          { item: 'Proviant/övrigt', price: '60–100 kr' },
        ],
      ],
      tips: [
        'Ta med matsäck för eftermiddagen — krogs öppettider är begränsade.',
        'Ta med boken "Vi på Saltkråkan" och läs på inspelningsplatsen — barnens och vuxnas Astrid Lindgren-nostalgi är stark här.',
        'Kombinera med Fejan eller Arholma för en full norrskärgårdsdag.',
      ],
    },
    tips: [
    ...
    restaurants: [
      {
        name: 'Nåttarö Krog',
        type: 'Restaurang',
        desc: 'Öns enda krog i ett naturreservat utan fastboende. Enkel husmanskost och fika. Ta alltid med extra proviant.',
        price_example: 'Räksmörgås 155–185 kr, soppa 115–145 kr, fika 65 kr',
        open_season: 'Juni–Augusti',
        open_hours: '11–17',
        book_required: false,
        book_note: 'Liten lokal — kan vara stängd vid dåligt väder. Ring i förväg.',
      },
    ],
    day_cost: {
      budget_per_person: '350–650 kr',
      includes: 'Utö Express t/r Nynäshamn, lunch på krogs och proviant.',
      breakdown: [
        [
          { item: 'SL-tåg Stockholm–Nynäshamn t/r', price: '145–200 kr' },
          { item: 'Utö Express Nynäshamn–Nåttarö t/r', price: '100–140 kr' },
          { item: 'Lunch, Nåttarö Krog', price: '115–185 kr' },
          { item: 'Proviant / extra matsäck', price: '60–100 kr' },
        ],
      ],
      tips: [
        'Ta alltid med rejäl matsäck — krogs öppettider begränsade och alternativ saknas helt.',
        'Anländ med Utö Express och gå direkt till sandstranden. Inte mer komplicerat än så.',
        'Håll utkik efter havsörn längs klippstigen österut — häckar på ön och syns tidiga morgnar.',
      ],
    },
    tips: [
    ...
    restaurants: [
      {
        name: 'Ingmarsö Krog',
        type: 'Restaurang',
        desc: 'Öns krog — säsongsbaserad meny med lokala råvaror i skärgårdsmiljö. Krögaren lagar mat med råvaror från öns egna bönder.',
        slug: 'ingmarso-krog',
        price_example: 'Dagens rätt 145–175 kr, kvällsmeny 195–265 kr',
        open_season: 'Juni–Augusti',
        open_hours: 'Lunch 12–15, middag 17–21',
        book_required: true,
        book_note: 'Rekommendera bokning för middag — liten krog med begränsat antal sittplatser.',
        child_menu: true,
      },
      {
        name: 'Ingmarsö Bageri',
        type: 'Bageri',
        desc: 'Nybakat bröd, fika och enkla bryggluncher. Klassiskt stopp för båtluffare och vandare.',
        price_example: 'Kaffe + bulle 65–75 kr, smörgås 85–115 kr',
        open_season: 'Maj–September',
        open_hours: '08–14',
      },
      {
        name: 'Ingmarsö Lanthandel',
        type: 'Handel',
        desc: 'Dagligvaror — öppen året om. Ta med matsäck om du planerar utflykt till de yttre klipporna.',
        open_season: 'Helår',
        open_hours: 'Vardagar 09–17, helg 10–15',
      },
    ],
    day_cost: {
      budget_per_person: '350–700 kr',
      includes: 'Waxholmsbåt t/r, kaffe + bulle på bageriet, lunch på krogs, och valfri fika.',
      breakdown: [
        [
          { item: 'Waxholmsbåt Strömkajen t/r', price: '155–230 kr' },
          { item: 'Kaffe + bulle, Ingmarsö Bageri', price: '65–75 kr' },
          { item: 'Lunch på Ingmarsö Krog', price: '145–175 kr' },
          { item: 'Matsäck / lanthandel', price: '60–100 kr' },
          { item: 'Eftermiddagsfika', price: '50–80 kr' },
        ],
      ],
      tips: [
        'Kör en dagstur Ingmarsö + Finnhamn via Båtluffarleden — ta Waxholmsbåten tidigt och räkna hela dagen.',
        'Ta med matförråd från lanthandeln till klippbad — inga kiosker längs stigen.',
        'Boka krogbordet redan hemma — det är en liten krog och blir fullt snabbt på sommaren.',
      ],
    },
    tips: [
  ...
  // ─── NÄMDÖ ───────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Nämdö Krog',
        type: 'Restaurang',
        desc: 'Husmanskost sommartid — enkel skärgårdsmat i en liten krog. Begränsat utbud, boka i förväg.',
        price_example: 'Lunch 135–165 kr, kvällsrätt 175–245 kr',
        open_season: 'Juni–Augusti',
        open_hours: 'Lunch 12–14, middag 17–20',
        book_required: true,
        book_note: 'Liten lokal — ring i förväg.',
        child_menu: true,
      },
      {
        name: 'Nämdö Lanthandel',
        type: 'Handel',
        desc: 'Dagligvaror och proviant — begränsat men tillräckligt för en dagsutflykt. Ta med extra om du planerar hela dagen.',
        open_season: 'Juni–Augusti',
        open_hours: '09–17',
      },
    ],
    day_cost: {
      budget_per_person: '300–600 kr',
      includes: 'Waxholmsbåt från Stavsnäs t/r, lunch på krogs och fika/proviant.',
      breakdown: [
        [
          { item: 'Waxholmsbåt Stavsnäs t/r', price: '90–130 kr' },
          { item: 'Lunch på Nämdö Krog', price: '135–165 kr' },
          { item: 'Proviant / lanthandel', price: '50–80 kr' },
          { item: 'Fika / kaffe', price: '40–60 kr' },
        ],
      ],
      tips: [
        'Ta med matsäck — krogen är liten och kan vara fullt bokat. Ön har inga alternativ.',
        'Nämdö är ett perfekt halvdagsstopp — kombinera med Möja eller Gällnö på samma dag via Waxholmsbåt.',
        'Åttakantiga kyrkan från 1798 är värd ett besök, öppen sommartid utan kostnad.',
      ],
    },
    tips: [
    ...
    restaurants: [
      {
        name: 'Svartsö Krog',
        type: 'Restaurang',
        desc: 'En av mellersta skärgårdens mest omtalade krogar. Säsongsbetonad meny med råvaror från öns egna odlingar och lokala fiskare. Boka i god tid.',
        slug: 'svartso-krog',
        price_example: 'Lunch 155–195 kr, kvällsmeny 225–325 kr',
        open_season: 'Maj–September',
        open_hours: 'Lunch 12–15, middag 17–21',
        book_required: true,
        book_note: 'Populär krog — boka gärna en vecka i förväg i juli.',
        phone: '08-542 480 40',
        child_menu: true,
      },
      {
        ...
        type: 'Handel',
        desc: 'Skärgårdens kanske bäst sorterade lanthandel — apotek- och Systembolagsombud. Öppen helår.',
        open_season: 'Helår',
        open_hours: 'Vardagar 09–18, lör 09–15, sön 10–14',
      },
    ],
    day_cost: {
      budget_per_person: '350–700 kr',
      includes: 'Waxholmsbåt t/r, cykeluthyrning, lunch på krogs och kaffe.',
      breakdown: [
        [
          { item: 'Waxholmsbåt Strömkajen t/r', price: '175–230 kr' },
          { item: 'Cykeluthyrning (halvdag)', price: '100–150 kr' },
          { item: 'Lunch på Svartsö Krog', price: '155–195 kr' },
          { item: 'Kaffe + proviant, lanthandeln', price: '60–100 kr' },
        ],
      ],
      tips: [
        'Boka Svartsö Krog minst en vecka i förväg i juli — de är ofta fullbokade kvällstid.',
        'Cykelrunda + lunch är det klassiska Svartsö-programmet. Hyr cykel vid Ahlsviks brygga.',
        'Lanthandeln har Systembolagets sortiment — perfekt för dem som anlöper med båt.',
      ],
    },
    tips: [
  ...
  // ─── RUNMARÖ ─────────────────────────────────────────────────
  {
    ...
    restaurants: [
      {
        name: 'Runmarö Krog',
        type: 'Restaurang',
        desc: 'Öns krog med enkel skärgårdsmat — husmanskost och klassiker. Populärt bland seglare.',
        price_example: 'Lunch 135–175 kr, kvällsrätt 185–265 kr',
        open_season: 'Juni–Augusti',
        open_hours: 'Lunch 12–15, middag 17–20',
        book_required: false,
        book_note: 'Kom i god tid i juli — gästhamnens båtar fyller krogen.',
        child_menu: true,
      },
      {
        name: 'Runmarö Lanthandel',
        type: 'Handel',
        desc: 'Proviant och dagligvaror — bra för att ladda inför nästa etapp. Kort säsong.',
        open_season: 'Juli–Mitten av Augusti',
        open_hours: '09–17',
      },
    ],
    day_cost: {
      budget_per_person: '350–650 kr',
      includes: 'Waxholmsbåt t/r, cykeluthyrning, lunch på krogens och proviant.',
      breakdown: [
        [
          { item: 'Waxholmsbåt Strömkajen t/r', price: '175–230 kr' },
          { item: 'Cykeluthyrning (heldag)', price: '100–150 kr' },
          { item: 'Lunch på Runmarö Krog', price: '135–175 kr' },
          { item: 'Proviant / lanthandel', price: '60–80 kr' },
        ],
      ],
      tips: [
        'Tranströmer-spåret till "Gatan" är gratis och tar en halv dag — ta med kaffe och macka.',
        'Runmarö är ett naturligt stopp för seglare på väg mot Sandhamn. Bränsle vid gästhamnen.',
        'Cykel + klippbad är det klassiska dagsprogrammet. Planera 5–6 h för en lugn runda.',
      ],
    },
    tips: [
