...
export const ISLANDS: Island[] = [
  ...
  // ─── VAXHOLM ─────────────────────────────────────────────────
  {
    ...
    description: [
      ...
      'Fästningen är mer imponerande på nära håll än på bild. Den anlades 1548 på Gustav Vasas order och har sedan dess förstärkts och byggts om — dagens kastell stod klart 1863. Fästningen har aldrig intagits: danskarnas anfall 1612 och ryssarnas härjningar 1719 slogs båda tillbaka. Idag är den ett välskött museum med utställningar om sjöförsvar och skärgårdshistoria. En bra aktivitet för en regnig dag.',
