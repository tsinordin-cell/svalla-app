...
export type IslandRestaurant = {
  ...
  websiteUrl?: string
  /** Prissättning, t.ex. "150–350 kr/pers" — visas på restaurang-undersidan */
  pris?: string
}
...
export type Island = {
  ...
  dog_notes?: string
  /**
   * Uppskattad dagskostnad per person — visas på ö-sidan och i jämförelseverktyg.
   * Alla priser är approximationer (Waxholmsbolaget prislista 2026 + restaurangmeny-koll).
   * OBS: SL-period/reskassa täcker de flesta Waxholmsbolaget-linjer inom Stockholms län.
   */
  day_cost?: {
    /** Tur-och-returbiljett med Waxholmsbolaget/SL från Stockholm (kr/person, utan SL-kort). */
    ferry_return_kr: number
    /** Budgetdag: färja + medhavd/enkel mat + fika. */
    budget_day_kr: number
    /** Normaldag: färja + lunch på restaurang + fika/glass. */
    typical_day_kr: number
    /** Valfri kommentar, t.ex. "SL-kort täcker färjan" */
    note?: string
  }
  /**
...
export const ISLANDS: Island[] = [
  ...
  // ─── SANDHAMN ────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Seglarrestaurangen', type: 'Restaurang', desc: 'Seglarhotellets krog — en av skärgårdens finaste. Boka i förväg.', bookingUrl: 'https://www.bokabord.se/restaurang/sandhamn-seglarhotell', websiteUrl: 'https://www.sandhamn.com', pris: '450–800 kr/pers' },
      { name: 'Sandhamns Värdshus', type: 'Restaurang', desc: 'Historisk krog vid färjebryggan. Enkel husmanskost och räkor.', bookingUrl: 'https://www.bokabord.se/restaurang/sandhamns-vardshus', websiteUrl: 'https://sandhamns-vardshus.se', pris: '200–380 kr/pers' },
      { name: 'Bistro Sands', type: 'Bistro', desc: 'Avslappnad bistro med havsutsikt och säsongsrätter.', slug: 'bistro-sands', pris: '150–280 kr/pers' },
      { name: 'Dykarbaren', type: 'Bar', desc: 'Bryggbar med hamburgare och öl. Populär för sundowner.', slug: 'dykarbaren', pris: '100–200 kr/pers' },
      { name: 'Sandhamns Bageriet', type: 'Bageri', desc: 'Nybakat varje morgon. Kö tidigt i juli.', slug: 'sandhamns-bageriet', pris: '40–120 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 520,
      typical_day_kr: 1100,
      note: 'Linje 444 via Stavsnäs, ca 180 kr/tur. SL-kort täcker ej hela sträckan — tillägg tillkommer. Sandhamn är dyraste restaurangön i skärgården.',
    },
    seasonal: {
      open: 'Maj–Oktober',
  ...
  // ─── UTÖ ─────────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Utö Värdshus', type: 'Restaurang', desc: 'Öns flaggskepp — vällagad mat med havsutsikt. Boka i förväg.', bookingUrl: 'https://www.utovardshus.se/restaurang/boka-bord-vardshuset/', websiteUrl: 'https://www.utovardshus.se', pris: '350–600 kr/pers' },
      { name: 'Seglarbaren', type: 'Bar', desc: 'Avslappnad hamn­bar för seglare och besökare.', slug: 'seglarbaren-uto', pris: '100–220 kr/pers' },
      { name: 'Hamnboden', type: 'Kiosk', desc: 'Enkel mat och dryck direkt vid hamnen.', slug: 'hamnboden-uto', pris: '50–120 kr/pers' },
      { name: 'Bakfickan Utö', type: 'Restaurang', desc: 'Gemytlig lokal restaurang med bra husmanskost.', slug: 'bakfickan-uto', pris: '160–320 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 480,
      typical_day_kr: 950,
      note: 'Pendeltåg till Nynäshamn (SL-kort) + Waxholmsbolaget-tillägg ca 150 kr/tur. Cykelhyra tillkommer (ca 150 kr/dag). Havsbastu: ca 150–200 kr/pers extra.',
    },
    seasonal: {
      open: 'Maj–Oktober',
      peak: 'Juli',
  ...
  // ─── VAXHOLM ─────────────────────────────────────────────────
  {
    ...
    accommodationIntro: 'Vaxholm har skärgårdens mest tillgängliga boendeutbud — det historiska Waxholms Hotell vid hamnen nås med bil, buss och direktbåt från Stockholm. Till skillnad från de yttre öarna kan man boka med relativt kort varsel och anlända utan att logistiken behöver planeras i förväg.',
    accommodation: [
    ...
    restaurants: [
      { name: 'Hamnkrogen Vaxholm', type: 'Restaurang', desc: 'Klassisk bryggkrog med räkor och husmanskost.', pris: '200–360 kr/pers' },
      { name: 'Winbergs Kök & Bar', type: 'Restaurang', desc: 'Enkel och bra mat i avslappnad miljö.', slug: 'winbergs-kok-bar', pris: '160–280 kr/pers' },
      { name: 'Getfoten Sjökrog', type: 'Restaurang', desc: 'Populär sjökrog söder om stan.', slug: 'getfoten-sjokrog', pris: '220–400 kr/pers' },
      { name: 'Mathantverkstan', type: 'Delikatess', desc: 'Rökt fisk och lokalt producerade skafferivaror.', pris: '80–200 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 200,
      typical_day_kr: 550,
      note: 'SL-kort täcker direktbåten (75 min) och buss 676. Kastell-entrén ca 100 kr. Vaxholm är skärgårdens mest budgetvänliga dagstur.',
    },
    seasonal: {
      open: 'Hela året',
      peak: 'Juli–Augusti',
  ...
  // ─── GRINDA ──────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Grinda Wärdshus Restaurang', type: 'Restaurang', desc: 'Skärgårdens bästa kök i detta prissegment. Boka.', bookingUrl: 'https://www.bokabord.se/restaurang/grinda-wardshus', websiteUrl: 'https://grinda.se', pris: '350–600 kr/pers' },
      { name: 'Framfickan', type: 'Bistro', desc: 'Bryggbistro nedanför wärdshuset. Lunch i solen.', slug: 'framfickan-grinda', pris: '150–280 kr/pers' },
      { name: 'Grinda Lanthandel & Café', type: 'Café', desc: 'Frukost, fika och proviant vid nedre hamnen.', slug: 'grinda-lanthandel-cafe', pris: '60–150 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 300,
      typical_day_kr: 800,
      note: 'SL-kort täcker direktbåten (ca 2 h). Budget nås med Framfickan och medhavd mat. Grinda Wärdshus höjer nivån markant — boka bord i förväg.',
    },
    dog_friendly: true,
  ...
  // ─── FINNHAMN ────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Finnhamns Krog', type: 'Restaurang', desc: 'Samlingsplatsen vid hamnen. Enkel och bra mat.', bookingUrl: 'https://www.bokabord.se/restaurang/finnhamns-krog', websiteUrl: 'https://finnhamn.se', pris: '180–320 kr/pers' },
      { name: 'Takbaren', type: 'Bar', desc: 'Bar med panoramautsikt från vandrarhemsbyggnadens tak.', pris: '80–160 kr/pers' },
      { name: 'Ragnars kiosk', type: 'Kiosk', desc: 'Glassbod och enkla tilltugg vid bryggan.', slug: 'ragnars-kiosk-finnhamn', pris: '30–80 kr/pers' },
      { name: 'Lanthandeln', type: 'Handel', desc: 'Proviant, kaffe och metmask. Allt du behöver.', pris: '40–100 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 250,
      typical_day_kr: 650,
      note: 'SL-kort täcker hela båtresan (ca 3 h). En av skärgårdens billigaste dagsdestinationer — vandrarhemsmat och kiosk håller nere kostnaden.',
    },
    seasonal: {
      open: 'Maj–September',
      peak: 'Juli',
  ...
  // ─── MÖJA ────────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Möja Värdshus & Bageri', type: 'Värdshus/Bageri', desc: 'Öns hjärta i Kyrkviken sedan 1951. Nybakt bröd från 7:00 och restaurang med utsikt. Öppet sommarsäsongen.', websiteUrl: 'https://mojavardshusochbageri.se', pris: '180–380 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 350,
      typical_day_kr: 750,
      note: 'Pendelbuss 428 från Slussen till Stavsnäs (SL-kort) + Waxholmsbolaget-tillägg ca 100 kr/tur. Bageriet är budgetfavoriten — nybakt bröd och kaffe.',
    },
    dog_friendly: true,
  ...
  // ─── FJÄDERHOLMARNA ──────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Fjäderholmarnas Krog', type: 'Restaurang', desc: 'Stor terrass, vällagad mat, direktbåt från stan. Boka i förväg.', pris: '380–700 kr/pers' },
      { name: 'Rökeriet Fjäderholmarna', type: 'Restaurang', desc: 'Klassiskt rökeriet sedan 80-talet. Rökt lax och sill i toppklass.', pris: '120–280 kr/pers' },
      { name: 'Fjäderholmarnas Bryggeri', type: 'Bar', desc: 'Hantverksöl med Stockholms siluett. Kväll och solnedgång.', slug: 'fjaderholmarna-bryggeri', pris: '80–160 kr/pers' },
      { name: 'The Old Smokehouse', type: 'Restaurang', desc: 'Rökt fisk och skaldjur take-away vid bryggan.', slug: 'old-smokehouse', pris: '100–220 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 200,
      typical_day_kr: 900,
      note: 'Waxholmsbåten ingår i SL-kort (25 min). Rökeriet är budgetalternativet. Fjäderholmarnas Krog är en av Stockholms dyraste skärgårdsrestauranger — räkna 500–700 kr/pers med dryck.',
    },
    seasonal: {
      open: 'April–Oktober',
      peak: 'Juli–Augusti',
  ...
  // ─── LJUSTERÖ ─────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Linanäsbryggan', type: 'Restaurang', desc: 'Klassisk brygga med mat och utsikt.', pris: '160–320 kr/pers' },
      { name: 'Klintan Sjöstation', type: 'Service/Café', desc: 'Bränsle, kaffe och enkla tilltugg.', slug: 'klintan-sjostation', pris: '40–100 kr/pers' },
      { name: 'Pizzeria Ljusterö', type: 'Restaurang', desc: 'Lokalbefolkningens val — avslappnat och bra.', slug: 'pizzeria-ljustero', pris: '80–160 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 220,
      typical_day_kr: 580,
      note: 'Buss 621 med SL-kort + avgiftsfri bilfärja. Cykeluthyrning vid färjeläget ca 150–200 kr/dag. Pizzeria Ljusterö är budgetkortet.',
    },
    seasonal: {
      open: 'April–Oktober',
      peak: 'Juli–Augusti',
  ...
  // ─── DALARÖ ──────────────────────────────────────────────────
  {
    ...
    restaurants: [
      { name: 'Dalarö Krog', type: 'Restaurang', desc: 'Klassisk hamn­krog med husmanskost och räkor.', pris: '180–350 kr/pers' },
      { name: 'Dalarö Värdshus', type: 'Restaurang', desc: 'Anrikt värdshus med god mat och historia.', pris: '220–420 kr/pers' },
      { name: 'Dalarö Bageri & Café', type: 'Bageri', desc: 'Morgonkaffet och nybakade bullar.', pris: '50–120 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 180,
      typical_day_kr: 600,
      note: 'Pendeltåg till Handen (SL-kort) + buss 834 (SL-kort). Tillgängligt med bil utan extra kostnad. Bageriet håller nere budgeten.',
    },
    seasonal: {
      open: 'April–Oktober',
      peak: 'Juli–Augusti',
  ...
  // ─── ARHOLMA ─────────────────────────────────────────────────
  {
    ...
    activities: [
      ...
      { icon: '🧒', name: 'Lekplats', desc: 'Arholma har en lekplats — ett uppskattat inslag för barnfamiljer som besöker ön.' },
    ],
    accommodation: [
    ...
    restaurants: [
      { name: 'Arholma Dansbana & Krog', type: 'Restaurang', desc: 'Öns krog och samlingspunkt. Enkel mat och sommarnöje.', slug: 'arholma-dansbana-krog', pris: '150–280 kr/pers' },
      { name: 'Arholma Hamnkrog', type: 'Restaurang', desc: 'Hamnkrogen för seglare vid gästhamnen.', pris: '120–240 kr/pers' },
    ],
    tips: [
    ...
    day_cost: {
      ...
      budget_day_kr: 400,
      typical_day_kr: 850,
      note: 'Pendeltåg till Norrtälje (SL-kort) + Waxholmsbolaget-tillägg ca 100 kr/tur. Alternativt bil till Simpnäs + passagerarfärja. Arholma är ytterskärgård — ta med extra proviant.',
    },
    seasonal: {
      open: 'Juni–September',
      peak: 'Juli–Mitten av Augusti',
