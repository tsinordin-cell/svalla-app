  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f7fbfc', paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 20px' }}>
        <div style={{ background: '#fff', borderRadius: 16, padding: '36px 32px', boxShadow: '0 2px 16px rgba(0,0,0,0.06)', lineHeight: 1.75, color: '#2a4a5a', fontSize: 15 }}>
          <h2 style={{ color: '#162d3a', fontSize: 20, marginTop: 0 }}>Vad är Svalla?</h2>
          <p>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 20 }}>Varför vi byggde det</h2>
          <p>
          ...
          <h2 style={{ color: '#162d3a', fontSize: 20 }}>Kontakt</h2>
          <p>
