...
export const STATIC_CATEGORIES: ForumCategory[] = [
  ...
  { id: 'motorbat',         name: 'Motorbåt',           description: 'Motorteknik, bränsle, navigation och service',  icon: '', iconName: 'ship',      iconColor: '#c96e2a', sort_order: 2, thread_count: 0, post_count: 0 },
  { id: 'fiske',            name: 'Fiske',              description: 'Fiskeplatser, regler, spön och drag',           icon: '', iconName: 'fish',      iconColor: '#0a7b8c', sort_order: 3, thread_count: 0, post_count: 0 },
  { id: 'paddling',         name: 'Paddling',           description: 'Kajak, SUP, kanot — allt som paddlas',          icon: '', iconName: 'paddle',    iconColor: '#0a7b3c', sort_order: 4, thread_count: 0, post_count: 0 },
  ...
  { id: 'teknik-underhall', name: 'Teknik & underhåll', description: 'Motor, elektronik, rigg och verkstad',          icon: '', iconName: 'wrench',    iconColor: '#525252', sort_order: 6, thread_count: 0, post_count: 0 },
  ...
  { id: 'nyborjare',        name: 'Nybörjare',          description: 'Inga dumma frågor — fråga allt här',            icon: '', iconName: 'compass',   iconColor: '#9d174d', sort_order: 8, thread_count: 0, post_count: 0 },
